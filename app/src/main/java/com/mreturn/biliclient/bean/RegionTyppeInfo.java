 ...
 * 分区
 */
public class RegionTyppeInfo implements Parcelable {
    private int code;
    ...
    public RegionTyppeInfo() {

    }

    protected RegionTyppeInfo(Parcel in) {
    ...
    public static final Parcelable.Creator<RegionTyppeInfo> CREATOR = new Parcelable.Creator<RegionTyppeInfo>() {

        @Override
        public RegionTyppeInfo createFromParcel(Parcel source) {

            return new RegionTyppeInfo(source);
        }


        @Override
        public RegionTyppeInfo[] newArray(int size) {

            return new RegionTyppeInfo[size];
        }
    };
}
